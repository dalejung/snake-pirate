"""
Adds a to_py() method to `Vector`. If possible, it will create a direct
translation such as xts -> pd.DataFrame.
"""
from collections import OrderedDict

from rpy2.rinterface import SexpVector, RNULLType
from rpy2.robjects.vectors import Vector, DataFrame, ListVector, StrVector
